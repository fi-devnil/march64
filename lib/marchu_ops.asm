...
test:       jsr insert_current_chunk_signs
            ...
            jsr test_up
            jsr marchu_tests.marchu_w0

            jsr test_up
            jsr marchu_tests.marchu_r0w1r1w0

            jsr test_up
            jsr marchu_tests.marchu_r0w1

            jsr test_down
            jsr marchu_tests.marchu_r1w0r0w1

            jsr test_down
            jsr marchu_tests.marchu_r1w0
...
reset_registers:  lda #$00
                  ...
                  tay         // reset Y to $00
                  ldx #$40    // reset X to $30 (Screen code for 0)
                  rts
...
marchu_w0:      lda #$00
                ...
                jsr next_byte
                jsr cmp_add_hi_u
                beq cmp_add_lo_u // <-- bug? does rts, returning from test too early
                bne marchu_w0
                beq return
/* should be:   jsr cmp_add_hi_u
                bne marchu_w0
                jsr cmp_add_lo_u
                bne marchu_w0
                beq return */
