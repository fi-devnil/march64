set_vic2_addresses: {
	lda #%00010000		// Set Screen to $0400 and CharMem to $0000
	sta $d018	
}
...
move_screen_ops: {
                lda #<SCREEN_OPS_FROM_ROM_ADDR  // From
                sta $fb
...
move_screen_data: {
                  lda #<SCREEN_DATA_FROM_ROM_ADDR // From
                  sta $fb
...
move_marchu_ops: {
                lda #<MARCHU_OPS_FROM_ROM_ADDR  // From
                sta $fb
